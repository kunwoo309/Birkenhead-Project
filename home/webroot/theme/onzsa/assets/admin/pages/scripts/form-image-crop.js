var FormImageCrop = function () {
    ...
    var demo5 = function() {
        ...
        $('#img1').click(function(e) {
          ...
          jcrop_api.setImage('/theme/onzsa/assets/global/plugins/jcrop/demos/demo_files/sago.jpg');
        ...
        $('#img2').click(function(e) {
          ...
          jcrop_api.setImage('/theme/onzsa/assets/global/plugins/jcrop/demos/demo_files/pool.jpg');
          jcrop_api.setOptions({ bgOpacity: .6 });
          return false;
        });
        $('#img3').click(function(e) {
          ...
          jcrop_api.setImage('/theme/onzsa/assets/global/plugins/jcrop/demos/demo_files/sago.jpg',function(){
            this.setOptions({
              bgOpacity: 1,
              outerImage: '/theme/onzsa/assets/global/plugins/jcrop/demos/demo_files/sagomod.jpg'
            });
